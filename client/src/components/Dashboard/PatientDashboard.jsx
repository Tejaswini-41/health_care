...
const PatientDashboard = () => {
    ...
    const renderContent = () => {
        switch(activeTab) {
                            ...
                            {appointments.map(apt => (
                                <div key={apt._id} className={`appointment-card ${apt.status.toLowerCase()}`}>
                                    ...
                                    <div className="card-body">
                                        <p><i className="fas fa-calendar"></i> {new Date(apt.date).toLocaleDateString()}</p>
                                        <p><i className="fas fa-clock"></i> {apt.time}</p>
                                        <p><i className="fas fa-user-md"></i> {apt.doctor.specialization}</p>
                                        <p className="symptoms"><i className="fas fa-notes-medical"></i> {apt.symptoms}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
            ...
            case 'book':
                return <BookAppointment onSuccess={() => setActiveTab('appointments')} />;
            default:
                return (
